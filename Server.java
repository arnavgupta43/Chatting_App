...
public class Server implements ActionListener {
    ...
    Server() {
        ...
        p1.setBackground(new Color(50, 50, 150));  
        ...
        morevert.setBounds(420, 20, 12, 20);
        p1.add(morevert);
        ...
        send.setBackground(new Color(50, 50, 150));  
