...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        p1.setBackground(new Color(50, 94, 120)); 
      ...
      ImageIcon i9 = new ImageIcon(i8);
        ...
        Image i11 = i10.getImage().getScaledInstance(32, 30, Image.SCALE_DEFAULT); 
        ImageIcon i12 = new ImageIcon(i11);
        JLabel phone = new JLabel(i12);
        phone.setBounds(360, 20, 32, 30);
        p1.add(phone);
        ...
        morevert.setBounds(420, 20, 12, 25);
        p1.add(morevert);
        ...
        text.setFont(new Font("Arial", Font.PLAIN, 16)); l
        f.add(text);
        
        JButton send = new JButton("Send");
        send.setBounds(320, 655, 123, 40);
        send.setBackground(new Color(50, 94, 120)); 
    ...
    public static JPanel formatLabel(String out) {
        ...
        output.setBackground(new Color(200, 255, 200)); // Changed message background color to light green
        ...
        time.setForeground(Color.GRAY); // Added gray color to the timestamp
    ...
    public static void main(String[] args) {
        ...
        try {
            Socket s = new Socket("127.0.0.5", 6001);
